...
class AccountBillingSetup extends React.PureComponent {
  static navigationOptions = ({ navigation, screenProps }) => ({
    ...
    headerRight: (<Text style={Styles.headerRightText} onPress={() => { navigation.navigate('SOCIAL_ACCOUNTS_SETUP'); }}>NEXT</Text>),
  });
...
export default withTheme(AccountBillingSetup);
